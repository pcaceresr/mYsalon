...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnToAgregarCita = findViewById<Button>(R.id.activity_main_btn_agregar)
        ...
        val btnToClientes = findViewById<Button>(R.id.activity_main_btn_clientes)
        ...
        val tvToVerCita = findViewById<TextView>(R.id.activity_main_agenta_Citas_tv_Cliente1)
